  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-sky-100 via-white to-sky-200">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold text-sky-700 mb-6 text-center">Register</h2>
        ...
        <input
          ...
          required
        />
        <Button text={isLoading ? 'Registering...' : 'Register'} className="w-full" />
        <div className="mt-4 text-center">
          <span className="text-sky-700">Already have an account? </span>
          <a href="/login" className="text-sky-900 font-semibold hover:underline">Login</a>
        </div>
      </form>
    </div>
  );
